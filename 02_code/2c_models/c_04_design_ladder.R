...
# most rows.
#
# The unidirectional row (the original submission's design) is built by c_03 - it needs its own
# panel. The negative-control column comes from c_02. d_09 stitches the three together.
