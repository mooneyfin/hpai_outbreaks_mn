...
# ============================================================
# Optional: visualize as a correlation heatmap
# ============================================================
...
# --- Cumulative plots ---
png(file.path(figures_folder, "figure_cumulative_ORs_casecrossover_val.png"),
...
# --- Slice plots ---
png(file.path(figures_folder, "figure_slice_ORs_casecrossover_val.png"),
    width = 11, height = 7, units = "in", res = 300)
par(mfrow = c(2, 4),
    mar = c(4.2, 4.2, 2.5, 1),
    oma = c(1, 1, 0, 1),
