...
# c_50 is the single pre-stated interaction model. Its robustness is stated in the manuscript
# in one clause and is NOT a supplement table, so the variants live here in data exploration.
# Each variant is c_50 with one line changed, made by text substitution on the script itself so
...
#
# Each writes si_interaction_primary_<tag>.RDS alongside c_50's si_interaction_primary.RDS.
...
BASE <- readLines(paste0(project.folder, "02_code/2c_models/c_50_interaction_primary.R"))
