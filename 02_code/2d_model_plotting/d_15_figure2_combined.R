...
#     Same ISO-week definition d_13 used for the bars, or the two would not line up.
...
mp  <- magick::image_read(file.path(figures_main_folder, "figure2_case_zone_map.png"))
...
ggsave_spark(file.path(figures_main_folder, "figure2_study_setting.png"),
             fig, width = W, height = H_MAP + H_CURVE)
cat("wrote figure2_study_setting.png\n")
