...
# Anseriformes abundance two to four weeks earlier (lag 15-28 d, not overlapping the weather window). This is the pre-stated interaction model (c_07):
...
#
# Nothing is refitted: the estimates are read off the cached c_07 output. The parse is strict so
...
ggsave_spark(file.path(figures_supplement_folder, "figureS3_interaction_all_panels.png"), fS3, width = 12, height = 13)
